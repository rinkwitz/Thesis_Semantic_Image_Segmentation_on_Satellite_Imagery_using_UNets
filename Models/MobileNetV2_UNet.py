...
class MobileNetV2_UNet(torch.nn.Module):
    ...
    def initialize_decoder_weights(self):
        for layer in [self.dec4_Conv2dBlock, self.dec3_UpConcat2d, self.dec3_Conv2dBlock, self.dec2_Conv2dBlock,
                      self.dec1_UpConcat2d, self.dec1_Conv2dBlock]:
...
if __name__ == '__main__':
    device = 'cuda:0'
    model = MobileNetV2_UNet(in_channels=3, num_categories=2, deep_supervision=True)
    model.to(device)
