...
class AttentionUNet(nn.Module):
    def __init__(self, in_channels, num_categories=2, filter_sizes=(64, 128, 256, 512, 1024), deep_supervision=False):
        ...
        self.main_model_name = 'attention_unet'
    ...
    def initialize_weights(self):
        for layer in [self.enc1_Conv2dBlock, self.enc2_Conv2dBlock, self.enc3_Conv2dBlock, self.enc4_Conv2dBlock,
                      self.enc5_Conv2dBlock, self.dec4_att_gate, self.dec4_UpConcat2d, self.dec4_Conv2dBlock,
                      self.dec3_att_gate, self.dec3_UpConcat2d, self.dec3_Conv2dBlock, self.dec2_att_gate,
                      self.dec2_UpConcat2d, self.dec2_Conv2dBlock, self.dec1_att_gate, self.dec1_UpConcat2d,
...
if __name__ == '__main__':
    ...
    model = AttentionUNet(in_channels=3, num_categories=2, filter_sizes=(32, 64, 128, 256, 512), deep_supervision=True)
    model.to(device)
